...
CREATE INDEX idx_process_type_fee_created_date ON t_process_type_fee(created_date DESC);
...
INSERT INTO t_fee_category (name, description, code, category_type, sort_order, created_by, last_modified_by) VALUES
