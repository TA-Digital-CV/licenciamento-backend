...
CREATE INDEX idx_license_issuer_created_at ON t_license_issuer(created_at DESC);
...
```json
{
  ...
  "notes": "Atualização de capacidade e taxas para 2025"
}
```
  ...
  "data": {
    ...
    "users": [
      ...
      },
      {
        ...
        "lastLoginAt": "2025-01-15T14:15:00Z",
        "createdAt": "2025-01-01T10:00:00Z"
      }
    ]
  }
