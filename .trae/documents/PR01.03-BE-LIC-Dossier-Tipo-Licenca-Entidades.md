...
CREATE INDEX idx_entity_created_date ON t_entity(created_date DESC);
...
public class OptimizedEntityQueryRepository {
    ...
    public PagedResult<EntityListResponse> searchEntitiesOptimized(SearchEntitiesQuery query) {
        ...
        String sql = """
            SELECT e.id, e.entity_name, e.entity_type, e.status, e.created_date,
        ...
        sql += " GROUP BY e.id, e.entity_name, e.entity_type, e.status, e.created_date, o.name";
